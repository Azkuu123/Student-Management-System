...
namespace StudentManagementSystem
{
    public partial class LoginUI : Form
    {
        ...
        //Extract method
        private void TogglePassword(TextBox txtBox, ref int flag, PictureBox picBox, Image openImg, Image closeImg)
        {
            if (flag == 1)
            {
                ...
                flag = 0;
                picBox.Image = null;
                picBox.BackgroundImage = openImg;
            ...
            else
            {
                ...
                flag = 1;
                picBox.Image = null;
                picBox.BackgroundImage = closeImg;
                picBox.BackgroundImageLayout = ImageLayout.Zoom;
            }
        }
        ...
        //Event handlers calling helper method Toggle Password
        int passwordHide = 1;
        private void picEyePassword_Click(object sender, EventArgs e)
        {
            TogglePassword(txtPassword, ref passwordHide, picEyePassword,
                StudentManagementSystem.Properties.Resources.eyeOpen,
                StudentManagementSystem.Properties.Resources.eyeClose);
        }

        int passwordHideSignup = 1;
        private void picEyePasswordSignup_Click(object sender, EventArgs e)
        {
            TogglePassword(txtPasswordSignup, ref passwordHideSignup, picEyePasswordSignup,
                StudentManagementSystem.Properties.Resources.eyeOpen,
                StudentManagementSystem.Properties.Resources.eyeClose);
        }
        ...
        {
            TogglePassword(txtRePasswordSignup, ref repasswordHideSignup, picEyeRePasswordSignup,
                StudentManagementSystem.Properties.Resources.eyeOpen,
                StudentManagementSystem.Properties.Resources.eyeClose);
        }

        //make extract method for these methods Toggle Password
        //int passwordHide = 1;
        //private void picEyePassword_Click(object sender, EventArgs e)
        //{
        //    if (passwordHide == 1)
        ...
        private void btSignup_Click(object sender, EventArgs e)
        {
            ...
            // Username only letters & digits
            if (!System.Text.RegularExpressions.Regex.IsMatch(txtUsernameSignup.Text, "^[a-zA-Z0-9]+$"))
            {
                MessageBox.Show("Username can only contain letters and numbers.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtUsernameSignup.Focus();
                return;
            }
        ...
        {
            // Empty check
            if (string.IsNullOrWhiteSpace(txtUserNIC.Text))
            {
            ...
            // NIC digits only
            if (!System.Text.RegularExpressions.Regex.IsMatch(txtUserNIC.Text, "^[0-9]+$"))
            {
                MessageBox.Show("NIC can only contain numbers.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtUserNIC.Focus();
                return;
            }

            // NIC length check (12 digits)
            if (txtUserNIC.Text.Length != 12)
            {
                MessageBox.Show("NIC must be 13 digits.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtUserNIC.Focus();
                return;
            }
